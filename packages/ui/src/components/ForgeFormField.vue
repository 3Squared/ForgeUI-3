<template>
  <div class="d-flex flex-column">
    ...
    <forge-checkbox :id="props.name" v-if="props.type === 'checkbox'" :label="props.label" :class="{'is-invalid': hasErrors }" v-bind="$attrs" />
    ...
    <small data-cy="error" class="invalid-feedback">{{ errorMessage || '&nbsp;'}}</small>
  </div>
</template>
