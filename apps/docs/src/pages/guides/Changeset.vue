...
" />
  <Image :src="ForgeChangelog" alt="Preview Card" class="mb-4" height="200" />
...
" />
  <Image :src="ChangesetWizard1Img" alt="Changeset Wizard" class="mb-4" height="200" />
...
" />
  <Image :src="ChangesetWizardMajorIma" alt="Changeset Wizard Major" class="mb-4" height="200" />
...
Next it will ask which projects require a `minor` version bump. If any do, select using space bar else press enter to continue.
  ...
  <Image :src="ChangesetImageMinorImg" alt="Changeset Wizard Minor" class="mb-4" height="200" />
...
Once you have selected either a `major`, `minor` or `patch` version number. You will be required to add a summary which will appear in the changelog. You can change this later.
  ...
  <Image :src="ChangesetWizardSummary" alt="Changeset Summary" class="mb-4" height="200" />
  <p>
...
<p>
Clicking into this file, you will find the changeset that you have created. It will detail the different version patches that the packages are due to receive and the summary that you entered in the wizard. You can/format this in this file, typically I find it easier to write my summary in here.
  </p>
