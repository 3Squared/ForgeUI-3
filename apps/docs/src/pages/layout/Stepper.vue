<template>
  <div>
    ...
    <p>
      ...
      <a class="link" target="_blank" href="https://primevue.org/steps/"><strong>PrimeVue documentation</strong></a>
      .
    </p>
...
const model = [{ label: "Step 1" }, { label: "Step 2", disabled: true }, { label: "Step 3" }];
