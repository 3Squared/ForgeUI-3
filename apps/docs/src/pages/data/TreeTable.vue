<template>
  <div>
    ...
    <Playground :options="options" :config="config" :code="code" display-value>
      <template #component>
        <component :is="ForgeTreeTable" v-bind="options" v-model:expanded-keys="expandedKeys" :value="nodes" class="w-100" />
      </template>
    </Playground>
...
import { ForgePageHeader, ForgeTreeTable } from "@3squared/forge-ui-3";
