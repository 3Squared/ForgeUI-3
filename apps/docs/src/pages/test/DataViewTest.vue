<template>
          ...
          <div class="d-flex border-bottom">
            ...
            <div class="p-1">
              <ForgeFormField v-model="pageSize" name="pageSize" type="select" field-label="Page size"
                              :options="sizingOptions" field-label-position="left" />
            </div> 
            <div class="p-1">
              <ForgeFormField v-model="date" name="pageSize" type="datepicker" field-label="Page size"
  ...
  <Card>
    <template #content>
      <ForgeTable :value="products" v-model:filters="filters">
        <Column
